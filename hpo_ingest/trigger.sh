...
#delete trigger
gcloud eventarc triggers delete hpo-storage-trigger --location=us-east1
#recreate trigger
gcloud eventarc triggers create hpo-storage-trigger \
    --location=us-east1 \
    --destination-run-service=hpo-ingest-service \
