"use strict";
function formatNearestMonth(date) {
 ...
 */
function determineMonthBasedOnRange(startDate, endDate) {
 ...
 */
function keyObjectById(inputObject) {
...
function convertCopiesStartAndEndValue(key, value) {
...
function normalizeValueKey(key, value) {
...
function normalizeAndKeyById(inputObject) {
...
if (typeof global !== 'undefined') {
    global.formatNearestMonth = formatNearestMonth;
}
